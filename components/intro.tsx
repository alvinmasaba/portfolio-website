...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className='font-bold'>Hello, I&apos;m Alvin.</span> I&apos;m a {" "}
        <span className='font-bold'>junior developer</span> actively {" "}
        <span className='font-bold'>seeking</span> experience. I enjoy
      ...
      >
        ...
        href="https://linkedin.com/in/alvinmasaba"
        target="_blank">
          <BsLinkedin />
        </a>
        ...
        transiition cursor-pointer borderBlack
        dark:text-white/60 dark:bg-white/10'
        href='https://github.com/alvinmasaba'
        target='_blank'>
          <FaGithubSquare />
        </a>
      </motion.div>
